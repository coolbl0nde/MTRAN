...
class Parser:
    ...
    def parse_function(self):
        function_type = self.current_token['lexeme']
        ...
        function_node = TreeNode("Func Definition", value=f"{function_name}", data_type=function_type)
    ...
    def parse_function_parameters(self, types=True):
        ...
        while self.position < len(self.tokens) and self.current_token['lexeme'] != ')':
            if types:
                param_type = self.current_token["lexeme"]
                self.next_token()
            ...
            if self.current_token['type'] == "IDENTIFIER":
                ...
                parameter_node = TreeNode("Parameter", value=f"{param_name}", data_type=param_type)
    ...
    def parse_variable_definition(self, type="Var Definition"):
        ...
        while True:
            ...
            var_node.add_child(TreeNode("Variable", value=f"{variable_name}", data_type=base_type))
    ...
    def parse_array(self):
        array_type = self.current_token["lexeme"]
        ...
        array_node = TreeNode(type="Array Definition")
        array_node.add_child(TreeNode("Array", value=f"{array_name}", data_type=array_type))
    ...
    def parse_struct_call(self):
        ...
        array_node = TreeNode("Struct Variable Definition", value=f"{struct_name}", data_type=struct_type)
